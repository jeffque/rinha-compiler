...
msg_and_bcb "apenas o stack dump do ternário..." \
...
msg_and_bcb "print(sumAndQuad(1, 10)) " \
...
msg_and_bcb "0, 1, 1, 1, _marm, X, X, X, X, print, X " \
...
msg_and_bcb "print de first de ((\$\"eu sou o Jeff, prazer\",#42),\$\"marmota\") " \
...
msg_and_bcb "print de second de first de ((\$\"eu sou o Jeff, prazer\",#42),\$\"marmota\") " \
...
msg_and_bcb "print de second de ((\$\"eu sou o Jeff, prazer\",#42),\$\"marmota\") " \
